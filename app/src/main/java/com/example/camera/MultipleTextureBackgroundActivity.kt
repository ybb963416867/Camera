...
import com.example.view.MultipleCombineBackgroundGlSurface

class MultipleTextureBackgroundActivity : AppCompatActivity() {
    private lateinit var glSurfaceView: MultipleCombineBackgroundGlSurface
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        this.enableEdgeToEdge()
        setContentView(R.layout.activity_multiple_texture_background)
