...
import com.example.view.MultipleCombineTextureGlSurface

class MultipleTextureCombineActivity : AppCompatActivity() {
    private lateinit var glSurfaceView: MultipleCombineTextureGlSurface
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_multiple_texture_combine)
