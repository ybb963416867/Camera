...
import com.example.view.MultipleTextureGlSurface

class MultipleTextureActivity : AppCompatActivity() {
    private lateinit var glSurfaceView: MultipleTextureGlSurface
