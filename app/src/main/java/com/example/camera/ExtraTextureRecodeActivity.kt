...
import com.example.view.ExtraTextureTouchGlSurface

class ExtraTextureRecodeActivity : AppCompatActivity() {
    private lateinit var glSurfaceView: ExtraTextureTouchGlSurface
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_extra_texture_recode)
