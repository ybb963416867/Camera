...
import com.example.rander.OffScreenViewLocationRender

class OffScreenViewLocationRecodeGlSurface(
    context: Context,
    attrs: AttributeSet? = null,
) : GLSurfaceView(context, attrs) {

    private var multipleRender: OffScreenViewLocationRender
    private var currentActiveTexture: IBaseTexture? = null
    private var currentResourceId = -1

    init {
        setEGLContextClientVersion(2)
        multipleRender = OffScreenViewLocationRender(this)
