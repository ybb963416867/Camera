...
open class BaseBackgroundTexture(
    ...
    val colorMatrix: FloatArray = Gl2Utils.getOriginalMatrix()
    var textureWidth = 0
    var textureHeight = 0
    ...
    override fun updateTexCord(coordinateRegion: CoordinateRegion) {
        ...
        val genColorImage = genColorImage(coordinateRegion.getWidth().toInt(), coordinateRegion.getHeight().toInt(), (0xffA728F0).toInt())
    ...
    override fun onDrawFrame() {
        ...
        colorBuffer?.let {
            ...
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, colorTexture)
            GLES20.glUniform1i(bTextureHandle, 0)
        }
